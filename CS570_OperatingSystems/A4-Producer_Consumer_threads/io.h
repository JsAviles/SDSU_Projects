/*
*
* Input output header file provided by Professor Ben Shen @ SDSU
*
*/
 ...
 */
void io_add_type(int producer, int OnBelt[], int Produced[]);
 ...
 */
void io_remove_type(int consumer, int product, int OnBelt[], int Consumed[]);
